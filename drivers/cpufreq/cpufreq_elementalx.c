...
static struct ex_dbs_tuners ex_tuners = {
	...
	.gboost_min_freq = DEF_INPUT_EVENT_TIMEOUT,
...
show_one(ex, input_event_timeout, input_event_timeout);
show_one(ex, input_min_freq, input_min_freq);
...
define_one_global_rw(input_min_freq);
